  ...
  return(<aside className="main-sidebar">
    <section className="sidebar">
      <ul className="sidebar-menu">
        ...
        <ul className="treeview-menu">
          <li className="active"><a href="/add-department"><i className="fa fa-circle-o"></i> Add Department </a></li>
          <li><a href="/manage-department"><i className="fa fa-circle-o"></i>Manage Department</a></li>
        </ul>
         </li>
